...
Biologically meaningful cascades emerge among the strongest cross-layer connections. Biologically meaningful cascades appear among the strongest cross-layer connections
...
4$\times$ overcomplete (4,608 atoms in 1,152 dimensions, of which 4,568 are alive at layer~11) and
resolves 814--1,360 distinct programs depending on depth (1,301 at L0, 814 at L5, 1,252 at L11,
...
Input distribution accounts for a difference of the same order. The same Geneformer dictionaries
reconstruct their own CRISPRi-like data 5--8 percentage points better than Tabula Sapiens at every
depth---0.8444 against 0.7731 at layer~0, for example. Both dictionaries sit close to the packing
limit for their dimensionality: mean absolute decoder coherence is 0.030--0.036 for Geneformer and
0.039--0.047 for scGPT, against Welch bounds of 0.0255 and 0.0362 respectively.
...
difference, with unannotated features equal or more responsive at the other three layers as well.
