...
\reply \textbf{Permission has been granted by Kanehisa Laboratories, and the permission document is
attached to this submission as a separate file.} No KEGG image, pathway map or diagram is
reproduced anywhere in the article, its figures or the Supplementary Information; KEGG is used only
as pathway-to-gene membership lists supplying the term sets for the enrichment analysis. As
required by the terms of the permission, KEGG is cited at every point of use, including in the
legends of figures whose content derives in part from KEGG gene sets, and in the Data availability
section.
...
checkpoints and feature catalogs are archived on Zenodo (doi:10.5281/zenodo.22068864) and mirrored
on GitHub.
