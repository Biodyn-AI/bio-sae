...
regulon in 2 of 13 cases (15\%) while the non-factor predictions are enriched for those same
regulons in 1 of 117 (1\%). Against the union of all confidence levels, whose regulons have a
median of 402 measured genes, the separation largely disappears (44\% against 27\%), so those
numbers do not measure regulatory recovery and we do not report them as such.

We think this is the most important outcome of the revision, and it qualifies our original claim.
...
can demonstrate specificity there. Where the transcriptome is measured and the perturbation is
strong, the features do carry a modest but genuinely factor-specific signal. The manuscript now
states both, in the abstract, the Results and the Discussion. We are grateful for the push that led
