...
\begin{itemize}
\item \textbf{K562 CRISPRi perturbation data}~\cite{replogle2022mapping}: available at \url{https://plus.figshare.com/articles/dataset/_Mapping_information-rich_genotype-phenotype_landscapes_with_genome-scale_Perturb-seq_Replogle_et_al_2022_processed_Perturb-seq_datasets/20029387} (Figshare+, DOI: 10.25452/figshare.plus.20029387.v1); the K562 genome-wide Perturb-seq data analysed here are the \texttt{K562\_gwps\_*} AnnData files.
