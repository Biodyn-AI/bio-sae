...
%% --- Figure S1: scGPT overview ---
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../figures/gb_figS1_scgpt_overview.pdf}
\caption{\textbf{scGPT feature atlas across all 12 layers.} \textbf{(A)}~Variance explained ranges from 85.7\% to 93.5\%, consistently higher than Geneformer. \textbf{(B)}~Dead features are concentrated in early layers (L0--L2) with near-zero elsewhere (49 total). \textbf{(C)}~Annotation rate is stable at 29--34\% across layers, lacking the pronounced U-shape seen in Geneformer. \textbf{(D)}~Co-activation modules average 6.3 per layer (76 total), comparable to Geneformer's 7.8.}
\label{fig:scgpt_overview}
\end{figure}


%% --- Figure S2: scGPT per-ontology ---
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../figures/gb_figS2_scgpt_ontology.pdf}
...
%% --- Figure S4: UMAP/force-directed overview ---
\begin{figure}[H]
\centering
...
%% --- Figure S6: Annotation-based projections ---
\begin{figure}[H]
\centering
